  ...
  <tr>
    <td style="padding: 10px; border: none; vertical-align: top;">
      <ul>
        ...
        <li><strong>User Authentication:</strong> A Keycloak-based login, implementing OAuth 2.0 Authorization Code + PKCE flow.</li>
...
| **Backend APIs** | [api.camelcase.club](https://api.camelcase.club) |  Backend Spring Boot based **APIs** are exposed at `api.camelcase.club`, secured with **OAuth 2.0**, and protected by by **AWS WAF**. <br> <br>See [ToDo API repo here](https://github.com/mm-camelcase/todo-service). |
